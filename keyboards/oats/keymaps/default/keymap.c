...
[_SPECIAL] = LAYOUT( \
  LSFT(KC_ESC),       KC_ESC,    BL_DEC,   BL_INC,   KC_MS_BTN1,   LSFT(LCTL(KC_TAB)), LCTL(KC_TAB), LSFT(LALT(KC__VOLDOWN)), LSFT(LALT(KC__VOLUP)), KC__VOLUP, \
  LCMD(KC_TAB),       KC_MS_L,   KC_MS_D,  KC_MS_U,  KC_MS_R,      KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC__VOLDOWN, \
  LSFT(LCMD(KC_TAB)), KC_LCTL,   MOD_LALT, KC_RCMD,  KC_MS_BTN2,   KC_HOME, KC_PGDN, KC_PGUP, KC_END,   KC__MUTE, \
