...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_TOP] = LAYOUT(
    ...
    TT(_COMMANDS), KC_LALT, KC_LCTL, TT(_SPECIAL), SFT_T(KC_BSPC), LCMD_T(KC_SPC), TT(_NUMS), KC_RCTL, XXXXX, XXXXX
  ),
  ...
  [_SPECIAL] = LAYOUT(
    ...
    XXXXX, XXXXX, APPL, APPR, XXXXX, KC_BRIU, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT,
    XXXXX, XXXXX, TABL, TABR, XXXXX, KC_BRID, KC_HOME, KC_PGDN, KC_PGUP, KC_END,
    _____, _____, _____, _____, _____, _____, _____, _____, _____, _____
  ),

  [_COMMANDS] = LAYOUT(
    XXXXX, XXXXX, XXXXX, XXXXX, RESET, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX,
